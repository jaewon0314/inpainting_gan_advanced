...
class CelebA(object):
    def __init__(self, flags, dataset_name):
        ...
        self.celeba_dataset_path = '../../img_align_celeba'
        self.celeba_train_path = '../../img_align_celeba/train'
        self.celeba_val_path = '../../img_align_celeba/val'


        if not os.path.isdir('../../img_align_celeba/train'):
    ...
    def _load_celeba(self):
        ...
        celeba_attr_f = open("../Data/" + self.flags.load_label, "r").readlines()
        if self.flags.y_dim:
